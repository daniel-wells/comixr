...
```{r, fig.width = 7}
plot.components(input, output)
plot.components(input, output, type = "density")

plot.components(input, output.vb)
plot.components(input, output.vb, type = "density")
```
...
plot.components(test.data.basic, output.test.basic, type = "density")
plot.components(test.data.basic, output.test.basic.vb)
plot.components(test.data.basic, output.test.basic.vb, type = "density")
```
...
initial.parameters.realistic <- data.table(
  w=c(0.5),
  mean=c(3,4,6,8,10,13,17,20,25,40,50,300,1,2),
  sigma2=c(8^2),
  component.type=c(rep("common",9),rep("specific",5)))

output.realistic <- fit.model(test.data.realistic[,.(vals,seg)],initial.parameters.realistic, max.iterations=12)
