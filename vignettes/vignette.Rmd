...
```{r}
input <- rbind(data.table(vals = rnorm(2000, mean = 5.0, sd = 0.75),seg="data1"),
               data.table(vals = rnorm(1000, mean = 0.5, sd = 1.0),seg="data1"),
              data.table(vals = rnorm(2000, mean = 5.5, sd = 0.75),seg="data2"),
              data.table(vals = rnorm(2000, mean = 4.0, sd = 3.0),seg="data2"))
```
...
```{r}
output <- fit.model(input, rho=0.5, initial.parameters)
```
